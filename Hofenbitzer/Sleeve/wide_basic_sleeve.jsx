...
(function () {
    ...
    function ensureBaseLayers(doc) {
        return {
            ...
            markers: ensureLayer(doc, "Markers"),
            labels: ensureLayer(doc, "Labels"),
            numbers: ensureLayer(doc, "Numbers")
        };
    }
    ...
    function draftWideBasicSleeve(context, derived) {
        ...
        drawDashedLine(layers.basicFrame, mark1, mark2, {
            name: "Cap Line",
    ...
    function buildVerticalAndSquares(layers, mark1, mark2, mark4Point, derived) {
        ...
        drawDashedLine(
            ...
            mark4Point,
            verticalEnd,
            buildLineLabelOptions("Sleeve Length", sleeveLengthCm, layers.labels)
        );
        ...
        drawDashedLine(layers.basicFrame, mark1Down5, mark2Down5, { name: "Hem Line" });
        drawDashedLine(layers.basicFrame, mark1Down6, mark2Down6, { name: "Elbow Line" });
    ...
    function addCapArcs(capLayer, mark1, mark2, mark4Point, derived) {
        if (!capLayer || !mark1 || !mark2 || !mark4Point || !derived) return;
        var points = computeCapMarkerPoints(mark1, mark2, mark4Point, derived);
